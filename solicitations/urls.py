...
urlpatterns = [
    ...
    path('scrape-progress/', views.scrape_progress,
         name='scrape-progress'),
    path('stop-scraping/', views.stop_scraping,
         name='stop_scraping'),
    path('cleanup-scrape-processes/', views.cleanup_scrape_processes,
         name='cleanup-scrape-processes'),
    ...
    path('settings/qcluster-monitoring/', views.qcluster_monitoring_settings, name='qcluster-monitoring-settings'),
    path('settings/', views.settings_page, name='settings'),
    path('rfq-auto-fetch-settings/', views.rfq_auto_fetch_settings, name='rfq-auto-fetch-settings'),
    path('rfq-auto-fetch-status/', views.rfq_auto_fetch_status, name='rfq-auto-fetch-status'),
    path('api/rfq-processing-status/', views.rfq_processing_status_api, name='rfq_processing_status_api'),
    ...
    path('get-unsent-count/', views.get_unsent_solicitations_count, name='get_unsent_count'),
    ...
    path('exported-replied-rfqs/', views.archived_replied_rfq, name='archived-replied-rfqs'),
    path('export-assessment-excel/', views.export_assessment_excel, name='export-assessment-excel'),
    ...
    path('ajax-dla-rules/', views.ajax_dla_rules, name='ajax-dla-rules'),
...
path('bulk-delete-replied-rfqs/', views.bulk_delete_replied_rfqs, name='bulk-delete-replied-rfqs'),
    path('rfq-assessment/<int:rfq_reply_id>/', views.rfq_assessment, name='rfq-assessment'),
    path('rfq-assessment/search/', views.rfq_assessment_search, name='rfq-assessment-search'),
    ...
    path('oem-import-progress/<str:progress_id>/', views.oem_import_progress, name='oem-import-progress'),
    ...
    path("scraping-schedule-settings/", views.scraping_schedule_settings, name="scraping-schedule-settings"),
    ...
    path('email-template-config/', views.email_template_config, name='email-template-config'),
    path('preview-email-template/', views.preview_email_template, name='preview-email-template'),
    path('apply-template-preset/', views.apply_template_preset, name='apply-template-preset'),
    path('save-text-style-override/', views.save_text_style_override, name='save-text-style-override'),

    # RFQ ID Configuration URLs
    path('clients/<int:client_id>/rfq-id-config/', views.rfq_id_config, name='rfq-id-config-client'),
    path('api/preview-rfq-id/', views.preview_rfq_id, name='preview-rfq-id'),
    path('api/reset-rfq-id-template/', views.reset_rfq_id_template, name='reset-rfq-id-template'),
    path('bid-reference-config/', views.bid_reference_config, name='bid-reference-config'),
    path('api/preview-bid-reference/', views.preview_bid_reference, name='preview-bid-reference'),
]
