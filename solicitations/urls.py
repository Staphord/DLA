...
urlpatterns = [
    ...
    path('check-user-profile/', views.check_user_profile, name='check_user_profile'),  
    ...
    path('check-rfq-task-status/', views.check_task_status, name='check_rfq_task_status'),
    path('check-solicitation-status/', views.check_solicitation_status, name='check_solicitation_status'),
    path('api/get-user-state/', views.get_user_state, name='get_user_state'),
    path('api/update-user-state/', views.update_user_state, name='update_user_state'),
    path('api/sync-processing-status/', views.sync_processing_status, name='sync_processing_status'),
    path('tasks/', views.user_tasks_list, name='user-tasks-list'),
    path('tasks/<str:session_id>/', views.task_details, name='task_details'),
    path('stop-processing/', views.stop_rfq_processing, name='stop_rfq_processing'),
    path('api/logs/<str:session_id>/recent/', views.get_recent_logs_api, name='recent_logs_api'),
    ...
    path('email-config/<int:client_id>/', views.email_config_view, name='email_config'),
    ...
    path('bulk-delete-reports/', views.bulk_delete_reports, name='bulk-delete-reports'),
    path('delete-single-report/', views.delete_single_report, name='delete-single-report'),
    path('bulk-delete-tasks/', views.bulk_delete_tasks, name='bulk-delete-tasks'),
    path('delete-single-task/', views.delete_single_task, name='delete-single-task'),
    ...
    path('clear-duplicate-flag/', views.clear_duplicate_flag, name='clear-duplicate-flag'),
    path('clear-import-duplicate-flag/', views.clear_import_duplicate_flag, name='clear-import-duplicate-flag'),
    ...
    path('search-disabled-oem/', views.search_disabled_oem, name='search-disabled-oem'),
